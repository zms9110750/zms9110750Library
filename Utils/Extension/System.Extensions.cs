...
namespace zms9110750.Utils.Extension
{
    ...
    public static class ArrayExtensions
    {
        ...
        public static Int32 BinarySearch(
            ...
            => Array.BinarySearch(array: array, index: index, length: length, value: value, comparer: comparer);
    ...
    public static class CharExtensions
    {
        ...
        public static Boolean IsSurrogatePair(
            this Char highSurrogate, Char lowSurrogate)
            => Char.IsSurrogatePair(highSurrogate: highSurrogate, lowSurrogate: lowSurrogate);
        ...
        public static Char ToLower(
            ...
            => Char.ToLower(c: c, culture: culture);
        ...
        public static Char ToUpper(
            this Char c, CultureInfo culture)
            => Char.ToUpper(c: c, culture: culture);
    ...
    public static class DateTimeExtensions
    {
        ...
        public static Int32 Compare(
            ...
            => DateTime.Compare(t1: t1, t2: t2);

        /// <inheritdoc cref="DateTime.Equals(DateTime, DateTime)"/>
        public static Boolean Equals(
            this DateTime t1, DateTime t2)
            => DateTime.Equals(t1: t1, t2: t2);
        ...
        public static DateTime SpecifyKind(
            ...
            => DateTime.SpecifyKind(value: value, kind: kind);
    ...
    public static class DateTimeOffsetExtensions
    {
        ...
        public static Int32 Compare(
            ...
            => DateTimeOffset.Compare(first: first, second: second);

        /// <inheritdoc cref="DateTimeOffset.Equals(DateTimeOffset, DateTimeOffset)"/>
        public static Boolean Equals(
            this DateTimeOffset first, DateTimeOffset second)
            => DateTimeOffset.Equals(first: first, second: second);
    ...
    public static class FormattableStringExtensions
    {
        ...
        public static String Invariant(
            ...
            => FormattableString.Invariant(formattable: formattable);
    ...
    public static class IntPtrExtensions
    {
        ...
        public static IntPtr Add(
            ...
            => IntPtr.Add(pointer: pointer, offset: offset);

        /// <inheritdoc cref="IntPtr.Subtract(IntPtr, Int32)"/>
        public static IntPtr Subtract(
            this IntPtr pointer, Int32 offset)
            => IntPtr.Subtract(pointer: pointer, offset: offset);
    ...
    public static class SingleExtensions
    {
        ...
        public static Boolean IsNegativeInfinity(
            this Single f)
            => Single.IsNegativeInfinity(f: f);

        /// <inheritdoc cref="Single.IsPositiveInfinity(Single)"/>
        public static Boolean IsPositiveInfinity(
            this Single f)
            => Single.IsPositiveInfinity(f: f);
    ...
    public static class StringExtensions
    {
        ...
        public static Int32 Compare(
            ...
            => String.Compare(strA: strA, strB: strB, comparisonType: comparisonType);
        ...
        public static Int32 Compare(
            ...
            => String.Compare(strA: strA, strB: strB, culture: culture, options: options);
        ...
        public static Int32 Compare(
            ...
            => String.Compare(strA: strA, strB: strB, ignoreCase: ignoreCase, culture: culture);
        ...
        public static Int32 Compare(
            ...
            => String.Compare(strA: strA, indexA: indexA, strB: strB, indexB: indexB, length: length);
        ...
        public static Int32 Compare(
            ...
            => String.Compare(strA: strA, indexA: indexA, strB: strB, indexB: indexB, length: length, ignoreCase: ignoreCase);
        ...
        public static Int32 Compare(
            ...
            => String.Compare(strA: strA, indexA: indexA, strB: strB, indexB: indexB, length: length, ignoreCase: ignoreCase, culture: culture);
        ...
        public static Int32 Compare(
            ...
            => String.Compare(strA: strA, indexA: indexA, strB: strB, indexB: indexB, length: length, culture: culture, options: options);
        ...
        public static String Join(
            ...
            => String.Join(separator: separator, value: value);

        /// <inheritdoc cref="String.Join(String, Object[])"/>
        public static String Join(
            this String separator, Object[] values)
            => String.Join(separator: separator, values: values);
        ...
        public static String Join(
            ...
            => String.Join(separator: separator, value: value, startIndex: startIndex, count: count);
    ...
    public static class TimeSpanExtensions
    {
        ...
        public static Int32 Compare(
            ...
            => TimeSpan.Compare(t1: t1, t2: t2);

        /// <inheritdoc cref="TimeSpan.Equals(TimeSpan, TimeSpan)"/>
        public static Boolean Equals(
            this TimeSpan t1, TimeSpan t2)
            => TimeSpan.Equals(t1: t1, t2: t2);
    ...
    public static class TypedReferenceExtensions
    {
        ...
        public static Type GetTargetType(
            ...
            => TypedReference.GetTargetType(value: value);
        ...
        public static RuntimeTypeHandle TargetTypeToken(
            this TypedReference value)
            => TypedReference.TargetTypeToken(value: value);

        /// <inheritdoc cref="TypedReference.ToObject(TypedReference)"/>
        public static Object ToObject(
            this TypedReference value)
            => TypedReference.ToObject(value: value);
    ...
    public static class UIntPtrExtensions
    {
        ...
        public static UIntPtr Add(
            ...
            => UIntPtr.Add(pointer: pointer, offset: offset);

        /// <inheritdoc cref="UIntPtr.Subtract(UIntPtr, Int32)"/>
        public static UIntPtr Subtract(
            this UIntPtr pointer, Int32 offset)
            => UIntPtr.Subtract(pointer: pointer, offset: offset);
